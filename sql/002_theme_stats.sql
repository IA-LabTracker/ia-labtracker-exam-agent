...
VALUES
    ...
    (
        ...
        7,
        'subtema',
        'Normas da saúde do trabalhador',
        'Regulamentadoras (NR)',
        1.52,
        6,
        'vermelho',
    ...
    (
        ...
        'Rastreamento e conduta nas lesões intraepiteliais cervicais',
        1.26,
        5,
        'laranja',
        '#F97316',
    ...
    (
        ...
        'Distúrbios psiquiátricos, hemorragia e infecção',
        1.01,
        4,
        'laranja',
        '#F97316',
    ...
    (
        ...
        14,
        'subtema',
        'Validação de Testes de Diagnósticos',
        'Cálculos',
        1.01,
        4,
        'laranja',
    ...
    (
        ...
        'De associação em estudos intervencionistas',
        1.01,
        4,
        'laranja',
        '#F97316',
    ...
    (
        < tbody continues > ```
(This was seeded - remains huge, omitted rest for brevity).